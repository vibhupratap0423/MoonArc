  ...
  return (
    <main className="min-h-screen bg-white text-black px-6 py-10">
      ...
      <form onSubmit={handleSubmit}>
        <section className="max-w-6xl mx-auto bg-gray-100 border border-purple-400 rounded-2xl p-10 md:p-16 space-y-10 fade-up opacity-0 translate-y-6 transition-all duration-700">
          ...
          <div>
            <label className="block mb-2 text-base font-medium text-purple-600">Looking For</label>
            <select
              name="plan"
              value={form.plan}
              onChange={handleChange}
              className="w-full px-5 py-3 rounded-lg bg-white border border-gray-400 text-black focus:ring-1 focus:ring-purple-500 transition"
              required
            >
          ...
          <div>
            <label className="block mb-2 text-base font-medium text-purple-600">Additional Message</label>
            <textarea
              name="message"
              value={form.message}
              onChange={handleChange}
              ...
              className="w-full px-5 py-3 rounded-lg bg-white border border-gray-400 text-black resize-none focus:ring-1 focus:ring-purple-500 transition"
              required
            />
          </div>
      ...
      <section className="max-w-6xl mx-auto mt-20 text-left fade-up opacity-0 translate-y-6 transition-all duration-700">
        <h3 className="text-2xl font-bold mb-4 text-purple-600">📞 Contact Information</h3>
        <p className="text-black mb-2">🏢 <strong>Moon Arc HQ</strong></p>
        <p className="text-gray-700 mb-1">D-404, Digital Avenue, Sector 5, Noida, India</p>
        <p className="text-gray-700 mb-1">📞 +91 92110 62253</p>
        <p className="text-gray-700">📧 hello@moonarc.in</p>
      </section>
...
function FormField({ label, name, value, onChange, type = 'text' }: FormFieldProps) {
  return (
    <div>
      <label className="block mb-2 text-base font-medium text-purple-600">{label}</label>
      <input
        type={type}
        name={name}
        value={value}
